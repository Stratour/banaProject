...
urlpatterns = [
    ...
    path('researched/matchings/', views.my_matchings_researched, name='my_matchings_researched'),
    ...
    path('proposed/matchings/', views.my_matchings_proposed, name='my_matchings_proposed'),
    ...
    path('proposed/simple/mine/', views.my_simple_trajects, name='my_simple_trajects'),
    path('proposed/simple/matchings/', views.my_matchings_simple, name='my_matchings_simple'),
    path('proposed/simple/delete/<int:pk>', views.delete_simple_traject, name='delete_simple_traject'),
